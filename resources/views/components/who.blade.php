<section class="who">
    <div class="who__container">
        <div class="who__grid">
            <!-- Image Section -->
            <div class="who__image-container">
                <div class="relative">
                    <img src="{{ ('asset/images/about.png') }}" alt="About Our Company - Who We Are" class="who__image">
                </div>
            </div>

            <!-- Content Section -->
            <div class="who__content-container">
                <div class="relative">
                    <!-- Section Title -->
                    <p class="who__title">
                        Who Are We
                    ...
                    <ul class="who__list">
                        <li class="who__list-item">
                            ...
                            <h3 class="who__list-text">Innovative Solutions</h3>
                        </li>
                        ...
                        <li class="who__list-item">
                            ...
                            <h3 class="who__list-text">Strategic Insights</h3>
                        </li>
                        ...
                        <li class="who__list-item">
                            ...
                            <h3 class="who__list-text">Unwavering Dedication</h3>
                        </li>
                    </ul>

                    <div class="h-[50px] lg:h-[30px]"></div>
                </div>
            </div>
        </div>
    </div>
